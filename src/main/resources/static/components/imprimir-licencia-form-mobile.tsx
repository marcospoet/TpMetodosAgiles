                      ...
                      <div className="max-h-[500px] overflow-y-auto scrollbar-thin">
                        ...
                        <div ref={licenciaRef} className="relative">
                          <div className="relative w-full" ref={licenciaFrenteRef}>
                            ...
                            <div className="absolute top-[22%] left-[35%] text-black text-[10px]">
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="border rounded-md overflow-hidden dark:border-slate-700">
                        <table className="w-full">
                          <thead className="bg-slate-100 dark:bg-slate-700">
                            <tr>
                              <th className="text-left p-2 text-xs dark:text-white">Concepto</th>
                              <th className="text-right p-2 text-xs dark:text-white">Importe</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr className="border-t dark:border-slate-700">
                              ...
                              <td className="p-2 text-right dark:text-white text-sm">${licenciaSeleccionada.costo}</td>
                            </tr>
                            <tr className="border-t bg-slate-50 dark:bg-slate-700 dark:border-slate-600">
                              <td className="p-2 font-semibold dark:text-white text-sm">TOTAL</td>
                              <td className="p-2 text-right font-semibold dark:text-white text-sm">
                    ...
                    <div className="border-t pt-4 flex justify-between dark:border-slate-700">
                      <div>
                        ...
                        <p className="dark:text-white text-sm">Admin Sistema</p>
                      </div>
                      <div className="text-right">
                        <p className="text-xs text-slate-500 dark:text-slate-400">FECHA Y HORA</p>
                        <p className="dark:text-white text-sm">{new Date().toLocaleString("es-ES")}</p>
                      </div>
                    </div>
                  </div>
                </div>
